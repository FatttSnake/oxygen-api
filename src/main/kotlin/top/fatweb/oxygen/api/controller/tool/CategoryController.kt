...
class CategoryController(
    ...
    fun add(@ProcessParam @RequestBody @Valid toolCategoryAddParam: ToolCategoryAddParam): ResponseResult<ToolCategoryVo> =
    ...
    fun update(@ProcessParam @RequestBody @Valid toolCategoryUpdateParam: ToolCategoryUpdateParam): ResponseResult<ToolCategoryVo> =
        ResponseResult.databaseSuccess(
